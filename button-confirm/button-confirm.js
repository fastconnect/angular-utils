...
'<div class="col-xs-6">' +
'<button class="btn-block btn btn-success" ng-click="$parent.confirm();$event.stopPropagation();">{{\'YES\' | translate}}</button>' +
'</div>' +
'<div class="col-xs-6">' +
'<button class="btn-block btn btn-danger" ng-click="$parent.cancel();$event.stopPropagation();">{{\'NO\' | translate}}</button>' +
'</div>' +
'</div>' +
'</div>' +
'</div>' +
